...
import { loadFont } from '@mapstore/utils/AgentUtils';
import assign from 'object-assign';
import Spinner from 'react-spinkit';
import '@mapstore/plugins/map/css/map.css';
import Message from '@mapstore/components/I18N/Message';
import ConfigUtils from '@mapstore/utils/ConfigUtils';
import { setMapResolutions, mapPluginLoad } from '@mapstore/actions/map';
import { isString } from 'lodash';
import selector from '@mapstore/plugins/map/selector';
import mapReducer from "@mapstore/reducers/map";
import layersReducer from "@mapstore/reducers/layers";
import drawReducer from "@mapstore/reducers/draw";
import boxReducer from '@mapstore/reducers/box';
import highlightReducer from "@mapstore/reducers/highlight";
import mapTypeReducer from "@mapstore/reducers/maptype";
import additionalLayersReducer from "@mapstore/reducers/additionallayers";
import mapEpics from "@mapstore/epics/map";
import pluginsCreator from "@js/plugins/map/index";
import withScalesDenominators from "@mapstore/components/map/enhancers/withScalesDenominators";
import { createFeatureFilter } from '@mapstore/utils/FilterUtils';
