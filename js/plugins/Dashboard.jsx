...
import {
    ...
    toggleMaximize
} from '@mapstore/actions/widgets';
import Dashboard from '@js/components/dashboard/Dashboard';
import widgetsReducers from '@mapstore/reducers/widgets';
import {
    dashboardResource,
    isBrowserMobile,
    isDashboardLoading,
    showConnectionsSelector
} from '@mapstore/selectors/dashboard';
import { currentLocaleLanguageSelector } from '@mapstore/selectors/locale';
import { isLocalizedLayerStylesEnabledSelector, localizedLayerStylesEnvSelector } from '@mapstore/selectors/localizedLayerStyles';
import {
    ...
    getMaximizedState
} from '@mapstore/selectors/widgets';
import dashboardReducers from '@mapstore/reducers/dashboard';
import dashboardEpics from '@mapstore/epics/dashboard';
import widgetsEpics from '@mapstore/epics/widgets';
