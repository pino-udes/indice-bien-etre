...
class RadarChartsDimensions extends React.Component {
    ...
    render() {
        ...
        var environnement_c5;
        var environnement_c6;
        var environnement_c7;
        var social_c1;
        var social_c2;
        var social_c3;
        var social_c4;
        ...
        if (this.props.data[0] && ['aire_diffusion', 'ilot_diffusion', 'hexagone'].includes(this.props.data[0].layer.id)) {
            ...
            if (parsedChartData.response.features.length > 0) {
                ...
                environnement_c5 = parsedChartData.response.features[0].properties.ibe_d1_c5;
                environnement_c6 = parsedChartData.response.features[0].properties.ibe_d1_c6;
                environnement_c7 = parsedChartData.response.features[0].properties.ibe_d1_c7;
                ...
                social_c9 = parsedChartData.response.features[0].properties.ibe_d2_c9;
                ...
                economique_c5 = parsedChartData.response.features[0].properties.ibe_d3_c5;
                economique_c6 = parsedChartData.response.features[0].properties.ibe_d3_c6;
            }
        } else {
            parsedChartData = "";
        }
        ...
        const parsedEnvironnementData = [
            { name: 'Accessibilité aux espaces verts', A: JSON.stringify(environnement_c2), "fill": "#ffc658" },
            { name: 'Risques naturels', A: JSON.stringify(environnement_c1), "fill": "#ffc658" },
            { name: 'Transport durable', A: JSON.stringify(environnement_c4), "fill": "#ffc658" },
            { name: '* Pollution de l’air', A: JSON.stringify(environnement_c5), "fill": "#ffc658" },
            { name: 'Environnement naturel et verdure', A: JSON.stringify(environnement_c3), "fill": "#ffc658" },
            { name: '* Qualité de l’eau', A: JSON.stringify(environnement_c6), "fill": "#ffc658" },
            { name: '* Gestion des déchets', A: JSON.stringify(environnement_c7), "fill": "#ffc658" }
        ];
        ...
        const parsedSocialData = [
            ...
            { name: '* Criminalité', A: JSON.stringify(social_c9), "fill": "#ffc658" }
        ];

        const parsedEconomiqueData = [
            { name: 'Emploi', A: JSON.stringify(economique_c1), "fill": "#ffc658" },
            { name: 'Chômage', A: JSON.stringify(economique_c2), "fill": "#ffc658" },
            { name: 'Accès à la propriété', A: JSON.stringify(economique_c3), "fill": "#ffc658" },
            { name: 'Commerces', A: JSON.stringify(economique_c4), "fill": "#ffc658" },
            { name: 'Niveau d’éducation', A: JSON.stringify(economique_c5), "fill": "#ffc658" },
            { name: '* PIB par habitants', A: JSON.stringify(economique_c6), "fill": "#ffc658" }
        ...
        return (
            <>
                ...
                <p><br/><i>* Indicateur extra-urbain</i></p>
            </>
        );
    }
}
