...
import withGroupColor from '@mapstore/components/widgets/enhancers/withGroupColor';
const DefaultWidget = withGroupColor(require('@mapstore/components/widgets/widget/DefaultWidget').default);
